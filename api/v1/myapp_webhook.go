...
var myapplog = logf.Log.WithName("myapp-resource")
...
// +kubebuilder:webhook:path=/mutate-app-dkj-com-v1-myapp,mutating=true,failurePolicy=fail,sideEffects=None,groups=app.dkj.com,resources=myapps,verbs=create;update,versions=v1,name=mmyapp.kb.io,admissionReviewVersions=v1
...
// +kubebuilder:webhook:path=/validate-app-dkj-com-v1-myapp,mutating=false,failurePolicy=fail,sideEffects=None,groups=app.dkj.com,resources=myapps,verbs=create;update,versions=v1,name=vmyapp.kb.io,admissionReviewVersions=v1
...
func (r *Myapp) validateApp() error {
	if !r.Spec.EnableService && r.Spec.EnableIngress {
		return apierrors.NewInvalid(GroupVersion.WithKind("Myapp").GroupKind(), r.Name,
			field.ErrorList{
